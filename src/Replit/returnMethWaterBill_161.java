...
public class returnMethWaterBill_161 {
/*
...
public static double waterTax(double units)
{
    ...
    public static double waterTax2(double units){
        return (units<+50 && units>=0)?units*0.60:(units>50 && units<100)?units*0.90:
                (units>100 && units<150)?(units*0.90)+50:(units*0.90)+100;
    }}