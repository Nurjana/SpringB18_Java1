...
//    A constructor accepting a single integer parameter whose value is used to initialize the maxTime instance variable.
 ...
 //A method named add that accepts an integer parameter. If the value of the parameter is equal to 25, the value of timeLeft
    // is increased by 30; otherwise no increase is performed. Furthermore, the increase occurs only if the value of timeLeft will
    // not exceed the value of maxTime. add returns a boolean value: true if timeLeft was increase, false otherwise.
...
//      if (timeLeft!=timeLeft &&timeLeft<0){
//        if (value==25) {
//             timeLeft += 30;
...
//    A method named tick that accepts no parameters and returns no value. tick decreases the value of
//    timeLeft by 1, but only if the value of timeLeft is greater than 0.
        public void tick(){
            if (timeLeft>0){
              timeLeft-=1;
             }
