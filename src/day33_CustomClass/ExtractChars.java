...
import java.util.ArrayList;
     ...
     */
        ...
        public static void main(String[] args) {
            ...
            ArrayList<Character> digits = new ArrayList<>();// will return all numbers from the list
            ArrayList<Character> specialChars = new ArrayList<>();//will return all special digits
